...
spy <- read_csv("C:/Users/josep/OneDrive/Documents/GitHub/STAT380FinalReport/SPY_data.csv",
                show_col_types = FALSE)

spy <- spy %>%
  rename(
    Date      = `...1`,        # change if your date col has a different name
...
##    (this is where we CREATE Diff and Indicator)
## =========================================================

# If your dates are like "01/15/2023", mdy() is right.
# If they are "2023-01-15", switch mdy() to ymd().
...
# Model 1: overall effect of surprise size
model1 <- lm(vol_change ~ Diff, data = events_all)
summary(model1)

# Model 2: effect differs by indicator type
